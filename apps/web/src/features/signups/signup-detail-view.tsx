...
import type { ResolvedSession, SignupDetail, TeamWithPoints } from "@vc/types"
...
import { AdminStatusControls, type AwardSummary } from "./components/admin-status-controls"
import { ClaimCell } from "./components/claim-cell"
...
export function SignupDetailView({ session, signup, teams }: SignupDetailViewProps) {
